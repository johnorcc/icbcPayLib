...
//        return base64_encode($encrypted);
        ...
        return base64_encode(openssl_encrypt($plaintext, 'AES-128-CBC', $key, OPENSSL_RAW_DATA,self::iv));
    }
...
//        $decrypted = openssl_decrypt(hex2bin($encrypted), 'AES-128-CBC', $key, OPENSSL_RAW_DATA);
//        return $decrypted;
        return openssl_decrypt(base64_decode($encrypted), "AES-128-CBC", $key, OPENSSL_RAW_DATA,self::iv);
    }
}
